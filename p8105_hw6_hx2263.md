...
```
    ...
    ##         bwt       bhead     blength       delwt     fincome     gaweeks 
    ##  1.00000000  0.74710678  0.74345075  0.28788931  0.15457151  0.41218335 
    ##    menarche     mheight      momage       ppbmi        ppwt      smoken 
    ## -0.02442466  0.19216320  0.13577340  0.09394573  0.18289196 -0.07562781 
    ##      wtgain 
    ##  0.24725259
...
**Comment**: Residual values bounce around 0, which is as expected. Residuals form a horizontal ‘band’ around zero: above and below. But not in random pattern, not evenly distributed around 0.
